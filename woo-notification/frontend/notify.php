...
class VI_WNOTIFICATION_F_Frontend_Notify {
    ...
    protected function get_product() {
        ...
        if ( $archive_page > 0 ) {
            ...
            switch ( $archive_page ) {
                case 1:
                    /*Select Products*/ /*Params from Settings*/ $archive_products = $this->settings->get_products();
                    ...
                    break;
                case 2:
                    /*Latest Products*/ /*Params from Settings*/ $args = array(
                    'post_type'      => 'product',
                    'post_status'    => 'publish',
                ...
                case 4:
                    ...
                    break;
                default:
                    /*Select Categories*/ $cates = $this->settings->get_categories();
                    if ( count( $cates ) ) {
