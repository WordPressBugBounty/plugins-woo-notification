...
- [Getting Started](https://docs.villatheme.com/?item=woocommerce-notification)

### Plugin Links

- [Project Page](https://villatheme.com)
- [Documentation](https://docs.villatheme.com/?item=woocommerce-notification)
...
2. Upload `woo-notification` to the `/wp-content/plugins/` directory
...
2024.05.06 - version 1.2.17
- Fixed: Wrong plugin name checking

2024.05.06 - version 1.2.16
- Fixed: Missing min Css support file

2024.04.11 - version 1.2.15
- Updated: Updated support file

2024.01.02 - version 1.2.14
...
2022.03.29 - version 1.2.6
- Updated: support class

2022.03.21 - version 1.2.5
...
2021.08.05 - version 1.2.3.9
- Updated: Compatibility with WP5.8 and WC5.5

2021.06.02 - version 1.2.3.8
- Update: support class

2020.12.12 - version 1.2.3.7
- Updated: Compatibility with WP5.6 and WC4.8

2020.08.12 - version 1.2.3.6
- Updated: Compatibility with WP5.5 and WC4.3

2020.04.23 - version 1.2.3.5
- Update: support class

2020.03.23 - version 1.2.3.4
- Fixed: support class

2020.03.23 - version 1.2.3.3
- Update: support class

2019.11.16 - version 1.2.3.2
- Updated: Compatible with WP 5.3 and WooCommerce 3.8

2019.10.07 - version 1.2.3.1
- Updated: Premium URL

2019.09.24 - version 1.2.3
...
2019.05.09 - version 1.2.2.5
- Updated: Change plugin name

2019.04.04 - version 1.2.2.4
- Updated: Make admin notices dismissible

2018.12.07 - version 1.2.2.3
- Fixed: Auto detect with SSL
- Updated: Class support

2018.11.29 - version 1.2.2.2
- Fixed: Update minify js and css

2018.11.23 - version 1.2.2.1
- Fixed: Tab JS in backend
- Fixed: Class support
- Fixed: Query out of stock

2018.11.21 - version 1.2.2
- Update: The same premium version

2018.11.10 - version 1.2.1.4.5
- Fixed: Support class

2018.10.17 - version 1.2.1.4.4
- Remove: Upgrade notice

2018.10.15 - version 1.2.1.4.3
- Remove: Upgrade notice

2018.07.13 - version 1.2.1.4.2
- Fixed: Class support

2018.05.11 - version 1.2.1.4.1
- Fixed: Class support

2018.04.16 - version 1.2.1.4
- Fixed: Class support

2018.04.11 - version 1.2.1.3
- Fixed: Class support

2018.04.09 - version 1.2.1.2
- Fixed: Class support

2018.03.05 - version 1.2.1.1
- Fixed: Class support

2017.12.12 - version 1.2.1
- Fixed: Javascript

2017.12.08 - version 1.2.0
- Updated: More feature

2017.11.02 - version 1.1.5.1
- Added: ABSPATH

2017.10.28 - version 1.1.5
- Fixed: Error when deactivated Pro version
- Fixed: Clickable when notification hide
- Fixed: Thumbnail not exist
- Updated: Data init

2017.10.08 - version 1.1.4
- Fixed: Random names and cities

2017.09.06 - version 1.1.3
- Optimized: Request db
- Fixed: Ajax search product with big data

2017.09.06 - version 1.1.2.1
- Optimize: Show on front page without Session

2017.08.20 - version 1.1.2
